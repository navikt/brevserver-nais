...
public class DialogueXMLParser {
	/**
	 * Metode foråskille ut meldingsheaderen og brevdata og putte disse inn i et kvitteringsobjekt.
	 * 
	 * @param bytesMelding
	 *            Meldingen
	...
	public static KvitteringVO lagKvitteringVOFraDialogueMelding(byte[] bytesMelding) throws BrevTechnicalException {
		...
		XMLService service = factory.createXMLService();

		KvitteringVO kvittering = service.marshalHeader(is);
