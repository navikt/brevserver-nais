...
/**
 * Definerer en Command. Det inneholder tilstanden til en operasjon, data og navn på operasjon. Navnet er brukt foråmappe en
...
public abstract class AbstractCommand {
	...
	/**
	 * Brukes foråhente ut resultatet av en operasjon
	 *
	 * @return Object
	 */
