...
@MessageDriven
public class BiBestillMdb extends BiAbstractMdb implements MessageListener {
	...
	public void onMessage(Message message) {
		String methSig = "BiBestillMdb.onMessage()";
		onMessage(methSig, message, QueueType.BI_BREVSERVER_ONLINEBREV);
	}
}