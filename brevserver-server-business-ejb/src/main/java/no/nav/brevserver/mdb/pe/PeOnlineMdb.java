...
@MessageDriven
public class PeOnlineMdb extends PeAbstractMdb implements MessageListener {
	...
	public void onMessage(Message message) {
		String methSig = "PeOnlineMdb.onMessage()";
		onMessage(methSig, message, QueueType.PE_BREVSERVER_MOTTAK_ONLINE);
	}
}