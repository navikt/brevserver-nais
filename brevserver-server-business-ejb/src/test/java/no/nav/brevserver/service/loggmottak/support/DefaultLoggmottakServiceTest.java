...
import no.nav.brevserver.service.loggmottak.to.LoggedException;
...
@PrepareForTest({DefaultLoggmottakService.class, Log.class})
public class DefaultLoggmottakServiceTest {
	...
	public void setUp() throws Exception{
		...
		createLogRequest();
		defaultLoggmottakService = new DefaultLoggmottakService();
