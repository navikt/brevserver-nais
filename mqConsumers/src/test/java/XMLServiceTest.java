...
import static no.nav.brevserver.xmlHandlers.XMLService.marshalBrevStatus;
import static no.nav.brevserver.xmlHandlers.XMLService.marshalHeader;
import static no.nav.brevserver.xmlHandlers.XMLService.unmarshal;
