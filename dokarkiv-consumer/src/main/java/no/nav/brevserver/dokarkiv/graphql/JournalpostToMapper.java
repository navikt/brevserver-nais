...
import no.nav.brevserver.dokarkiv.kodeverk.AvsenderMottakerIdType;
import no.nav.brevserver.dokarkiv.kodeverk.BrukerIdType;
import no.nav.brevserver.dokarkiv.kodeverk.Journalposttype;
import no.nav.brevserver.dokarkiv.kodeverk.Variantformat;

import java.util.List;
import java.util.stream.Collectors;

import static no.nav.brevserver.dokarkiv.util.MappingUtil.stringToEnum;
