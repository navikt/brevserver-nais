...
import no.nav.brevserver.ws.dokumentbehandling.support.impl.DefaultHentDokumentResponseMapper;
...
public class DefaultDokumentbehandlingServiceTest {
	...
	public void shouldCallHentDokument() throws BrevFunctionalException, BrevTechnicalException, BrevFinnesIkkeException {
		...
		no.nav.brevserver.ws.dokumentbehandling.to.HentDokumentRequest request = mock(no.nav.brevserver.ws.dokumentbehandling.to.HentDokumentRequest.class);
	...
	public void shouldCallLagreDokument() throws BrevException {
		...
		no.nav.brevserver.ws.dokumentbehandling.to.LagreDokumentRequest request = mock(no.nav.brevserver.ws.dokumentbehandling.to.LagreDokumentRequest.class);
		when(request.getBrevStatus()).thenReturn(createBrevStatus());
	...
	public void shouldCallAvbrytDokument() throws BrevException {
		...
		no.nav.brevserver.ws.dokumentbehandling.to.AvbrytDokumentRequest request = mock(no.nav.brevserver.ws.dokumentbehandling.to.AvbrytDokumentRequest.class);
		when(request.getBrevStatus()).thenReturn(createBrevStatus());
	...
	public void shouldCallFerdigstillDokument() throws BrevException {
		...
		no.nav.brevserver.ws.dokumentbehandling.to.FerdigstillDokumentRequest request = mock(no.nav.brevserver.ws.dokumentbehandling.to.FerdigstillDokumentRequest.class);
		when(request.getBrevStatus()).thenReturn(createBrevStatus());
