...
public class DefaultFerdigstillDokumentRequestMapperTest {
	...
	public void shouldMapFromWsRequestToDomainRequest() {
		no.nav.brevserver.ws.dokumentbehandling.to.FerdigstillDokumentRequest domainRequest = ferdigstillDokumentRequestMapper.map(createWsFerdigstillDokumentRequest());
