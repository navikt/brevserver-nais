package no.nav.brevserver.dokarkiv.graphql;
...
import static no.nav.brevserver.dokarkiv.util.ValidationUtil.assertDokumentFieldNotNullOrEmpty;
import static no.nav.brevserver.dokarkiv.util.ValidationUtil.assertJournalpostFieldNotNull;
import static no.nav.brevserver.dokarkiv.util.ValidationUtil.assertJournalpostFieldNotNullOrEmpty;
import static no.nav.brevserver.dokarkiv.util.ValidationUtil.assertNotNullOrEmpty;
