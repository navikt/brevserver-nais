package no.nav.brevserver.dokarkiv.impl;

import no.nav.brevserver.dokarkiv.SafGraphqlConsumer;
import no.nav.brevserver.dokarkiv.SafJournalpostQueryService;
import no.nav.brevserver.dokarkiv.graphql.GraphQLRequest;
import no.nav.brevserver.dokarkiv.graphql.JournalpostToMapper;
import no.nav.brevserver.dokarkiv.graphql.JournalpostToValidator;
