...
import no.nav.brevserver.core.constants.MDCConstants;
...
public class DokTimedAspect {
    ...
    @Around("execution (@no.nav.brevserver.core.metrics.Monitor * *.*(..))")
    ...
    //TODO: Sett inn en overordnet BrevserverTechnicalException og fiks feilhåndtering
